...
const FormSchema = z.object({
  ...
  companyPhone: z
    .string()
    .min(10, { message: 'Company phone must be atleast 10 numbers' }),
    ...
    <AlertDialog>
      <Card className="w-full">
        ...
        <CardContent>
          ...
          {data?.id && (
            <div className="flex flex-row items-center  justify-between border border-destructive gap-4 p-4 mt-4">
              <div>
                <div>Danger Zone</div>
              </div>
